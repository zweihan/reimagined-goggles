 ...
 */
public class ActivityTrackAppActivity 
    extends Activity {
                ...
                public void onClick( View view ) {
                    try {
                        ...
                        createToast( "Exception while starting data collection: " + 
                                      ( e.getMessage() == null ? "Check DDMS log" : e.getMessage() ) );
                    }
                }
            } );
    ...
    private void startSensorLogService() {
        ...
        // Start the service (foreground service)
        Intent intent = new Intent( this , ActivityTrackAppService.class );
        startService( intent );
    }
    ...
    private ServiceConnection connection = new ServiceConnection() {
            ...
            public void onServiceConnected( ComponentName className , 
                ...
                serviceApi = (ActivityTrackAppService.ActivityTrackAppServiceApi) binder;
                // Set flag
                isBound = true;
            }
    ...
    private void updateDisplayView( final String displayName , 
                                    final String updatedText ) {

        // Get the text view for this display name
        final TextView displayText = displayMap.get( displayName );
    ...
    /** Service's API. */
    private ActivityTrackAppService.ActivityTrackAppServiceApi serviceApi = null;
