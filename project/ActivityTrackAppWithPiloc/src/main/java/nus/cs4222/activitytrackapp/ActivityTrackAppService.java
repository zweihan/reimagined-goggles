...
import nus.cs4222.activitysim.*;

/** Service that samples and logs sensor data. */
public class ActivityTrackAppService
    extends Service 
    ...
    private void putServiceInForeground() {
        ...
        Intent launchIntent = new Intent( this , ActivityTrackAppActivity.class );
        ...
        */
        ...
        // Step 1b: Create a notification tied to this Intent
        String notificationTitle = "ActivityTrackApp Service" , 
            notificationText = "Tap to launch ActivityTrackApp's GUI";
    ...
    */
    ...
    public class ActivityTrackAppServiceApi 
        extends Binder {
        ...
        public void startDataCollection( String logName ) 
            ...
            // Initialise the simulator code
            ActivitySimulator.initSimulation( logName );
            // Get the activity detection algorithm
            detectionAlgo = ActivitySimulator.getDetectionAlgorithm();
        ...
        public void stopDataCollection() {
            try {
                ...
                stopSensorSampling();
                // De-initialise the simulator code
                ActivitySimulator.deinitSimulation();
                // Release the detection algo object reference
                detectionAlgo = null;
                // Close the log files
                closeLogFiles();
            }
                ...
                // Log the exception
                Log.e ( TAG , "Unable to cleanly stop data collection" , e );
                // Display a toast to the user
                Toast.makeText( getApplicationContext() , 
                                "Unable to cleanly stop data collection, check DDMS log" , 
                                Toast.LENGTH_SHORT ).show();
            }
        }
    ...
    private void startSensorSampling() {
        ...
        RealTimeDisplay.updateDisplay( ActivitySimulator.DISPLAY_DETECTION_RESULTS , "Wait for detection results...\n" );
    ...
    public class WiFiScanThread 
        ...
        public void run() {
            try {
                ...
                wifiScanReceiver = new BroadcastReceiver() {
                        ...
                        public void onReceive( Context context , Intent intent ) {
                            try {
                                ...
                                final Vector< Fingerprint > fingerprintVector = 
                                ...
                                mainHandler.post( new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            // Call the detection algo (in the main UI thread, like for other sensors)
                                            if( detectionAlgo != null ) {
                                                detectionAlgo.onWiFiSensorChanged( currentTime , fingerprintVector );
                                            }
                                        }
                                    } );
                ...
                ActivityTrackAppService.this.registerReceiver( wifiScanReceiver ,           // Broadcast receiver
        ...
        public void stopWiFiScans() {
            ...
            if( wifiScanReceiver != null ) {
                ActivityTrackAppService.this.unregisterReceiver( wifiScanReceiver );
    ...
    public void onSensorChanged( SensorEvent event ) {
        ...
        if( event.sensor.getType() == Sensor.TYPE_ACCELEROMETER ) {
            ...
            // Call the detection algo
            detectionAlgo.onAcclSensorChanged( currentTime , 
                                               x , 
                                               y , 
                                               z , 
                                               accuracy );
            ...
            // Call the detection algo
            detectionAlgo.onGravitySensorChanged( currentTime , 
                                                  x , 
                                                  y , 
                                                  z , 
                                                  accuracy );
            ...
            // Call the detection algo
            detectionAlgo.onLinearAcclSensorChanged( currentTime , 
                                                     x , 
                                                     y , 
                                                     z , 
                                                     accuracy );
            ...
            // Call the detection algo
            detectionAlgo.onMagneticSensorChanged( currentTime , 
                                                   x , 
                                                   y , 
                                                   z , 
                                                   accuracy );
            ...
            // Call the detection algo
            detectionAlgo.onGyroscopeSensorChanged( currentTime , 
                                                    x , 
                                                    y , 
                                                    z , 
                                                    accuracy );
            ...
            // Call the detection algo
            detectionAlgo.onRotationVectorSensorChanged( currentTime , 
                                                         x , 
                                                         y , 
                                                         z , 
                                                         scalar , 
            ...
            // Call the detection algo
            detectionAlgo.onBarometerSensorChanged( currentTime , 
                                                    pressure , 
                                                    altitude , 
                                                    accuracy );
        }
            ...
            // Call the detection algo
            detectionAlgo.onLightSensorChanged( currentTime , 
                                                light , 
                                                accuracy );
        }
            ...
            // Call the detection algo
            detectionAlgo.onProximitySensorChanged( currentTime , 
                                                    proximity , 
                                                    accuracy );
        }
        else {
    ...
    public void onLocationChanged( Location location ) {
        ...
        // Call the detection algo
        detectionAlgo.onLocationSensorChanged( currentTime , 
                                               provider , 
                                               latitude , 
                                               longitude , 
                                               accuracy , 
    ...
    private void registerSensorDisplays() {
        // Add a real-time GUI display for detected activities
        RealTimeDisplay.addDisplay( ActivitySimulator.DISPLAY_DETECTION_RESULTS , "Wait for detection results...\n" );
        // Sensor GUI displays
    ...
    private final IBinder binder = new ActivityTrackAppServiceApi();

    /** Flag to indicate that the service is in foreground. */
    private volatile boolean isForeground = false;

    /** Reference to the activity detection algorithm. */
    private ActivityDetection detectionAlgo = null;
